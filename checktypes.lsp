(defun checktypes ( / H0sqr Hsqr plusminus minusplus param)
	...
	(print (- Hsqr H0sqr))
	(print (expt (cot (/ pi (atoi (get_tile "n")))) 2))
	...
	(cond
		...
		((> (abs (- Hsqr H0sqr)) (expt (cot (/ pi (atoi (get_tile "n")))) 2)) (set_tile "error" "ERROR: Your parameters have failed to meet the design constraint |(H/b)^2 - (H0/b)^2| <= cot^2(pi/n)"))
