(defun checktypes()
	...
	(cond
		...
		((not (distof (get_tile "diameter"))) (set_tile "error" "ERROR: Please enter a real value for the diameter"))
		((<= (distof (get_tile "diameter")) 0) (set_tile "error" "ERROR: the diameter has to be greater than 0"))
		((>= (atoi (get_tile "n")) 4) (done_dialog))
	)
)
(princ)